"""
DCASE 2026 Task 1 - v6
Classifier-level improvements on CLAP features:
- Focal loss (helps weak classes)
- Label smoothing (better generalization)
- Bigger MLP with more dropout (more capacity)
- Cosine LR scheduler (smooth annealing)
"""
